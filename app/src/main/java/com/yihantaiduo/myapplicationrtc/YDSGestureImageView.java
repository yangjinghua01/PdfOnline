...
public class YDSGestureImageView extends ImageView {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == YDSGestureImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         *
         * @param YDSGestureImageView
         *
         * @see #getOuterMatrix(Matrix)
         * @see #getCurrentImageMatrix(Matrix)
         * @see #getImageBound(RectF)
         */
        void onOuterMatrixChanged(YDSGestureImageView YDSGestureImageView);
    }
    ...
    public YDSGestureImageView(Context context) {
        super(context);
        initView();
    }

    public YDSGestureImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public YDSGestureImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(YDSGestureImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(YDSGestureImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(YDSGestureImageView.this);
            }
            return true;
        }
    });
